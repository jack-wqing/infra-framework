 ...
 */
@Slf4j
public class FileConsoleRollAppenderLoader extends BaseAppenderLoader implements ILogAppenderLoader {

	private static String appenderName = "FILE_CONSOLE_ROLL_LOG_APPENDER";
	...
	public void load(LoggerContext loggerContext, Environment environment) {
		...
		if (logPlatform == null) {
			String consoleLog = BASE_LOG_PATH + loggerName + "/console/console.log";
			String fileNamePattern = BASE_LOG_PATH + loggerName + "/console/console.%d{yyyy-MM-dd}.%i.log";
