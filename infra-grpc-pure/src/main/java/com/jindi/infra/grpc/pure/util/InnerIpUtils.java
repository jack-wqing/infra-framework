...
public class InnerIpUtils {
	...
	private static final String RPC_LISTEN_INTERFACE = "rpc.listen.interface";
	private static final String INTERFACE = System.getProperty(RPC_LISTEN_INTERFACE);
	...
	private static String getInnerIP() {
		try {
			...
			while (interfaces.hasMoreElements()) {
				...
				if (StringUtils.isNotBlank(INTERFACE) && !Objects.equals(name, INTERFACE)) {
					continue;
				}
