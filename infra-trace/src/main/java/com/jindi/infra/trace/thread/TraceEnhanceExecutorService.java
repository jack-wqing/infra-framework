 ...
 * @date 2021/8/4
 */
public class TraceEnhanceExecutorService implements ExecutorService {

	private ExecutorService delegate;

	public TraceEnhanceExecutorService(ExecutorService executorService) {
	...
	private <T> Collection<? extends Callable<T>> wrapCallable(Collection<? extends Callable<T>> tasks) {
